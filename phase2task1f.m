function similarity = phase2task1f(f1, f2, connectivity_graph_file)
    ...
    epidemic_file_1 = strcat('epidemic_word_file_',f1);
    epidemic_file_2 = strcat('epidemic_word_file_',f2);
